...
const newsData = [
  {
    ...
    content: 'We are excited to announce our new Diamond investment plan with enhanced benefits...',
    category: 'Investment',
    author: 'Admin',
  ...
  },
  {
    ...
    content: 'Scheduled maintenance will be performed on June 20th from 2:00 AM to 4:00 AM...',
  ...
  {
    id: 3,
    title: 'Special Bonus Campaign',
    content: 'Join our special bonus campaign and earn extra rewards this month...',
    category: 'Promotion',
    author: 'Marketing',
...
const adsData = [
  {
    id: 1,
    title: 'Summer Investment Offer',
    description: 'Get 20% bonus on all investment plans',
    type: 'Banner',
    placement: 'Homepage',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage news articles, advertisements, and marketing content</p>
        </div>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="content" placeholder="Enter content description" rows={6} />
              </div>
              <div className="space-y-2">
              ...
              <div className="flex justify-end space-x-2">
                ...
                <Button className="bg-orange-500 hover:bg-orange-600">Create Content</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>
                ...
                {[1, 2, 3, 4, 5, 6].map((banner) => (
                  <Card key={banner}>
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-2">
                        <h4 className="font-medium">Marketing Banner {banner}</h4>
                        <p className="text-sm text-gray-500">Homepage placement</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h4 className="font-medium text-orange-600 mb-3">Content Requirements</h4>
              <ul className="space-y-2 text-sm text-gray-600">
